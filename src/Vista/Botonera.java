...
public class Botonera {
	...
	public Botonera(JuegoVista juego) {
		...
		Button botonArriba = crearBoton(1575,955,"↑",2,40,0);
		...
		Button botonAbajo = crearBoton(1575,955,"↓",2,40,80);
		...
		Button botonDerecha = crearBoton(1585,955,"→",2,60,40);
		...
		Button botonIzquierda = crearBoton(1585,955,"←",2,0,40);
